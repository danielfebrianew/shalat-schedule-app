...
class Jadwal {
  ...
  static Future<List<Jadwal>> fetchJadwal(
      String? kodeKota, String? kodeTahun, String? kodeBulan) async {
    List<Jadwal> results = [];
    final response = await http.get(Uri.parse(
        'https://api.myquran.com/v2/sholat/jadwal/$kodeKota/$kodeTahun/$kodeBulan'));
